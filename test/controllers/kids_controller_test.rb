...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { birthdate: @kid.birthdate, family_id: @kid.family_id, grade: @kid.grade, name: @kid.name } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { birthdate: @kid.birthdate, family_id: @kid.family_id, grade: @kid.grade, name: @kid.name } }
